 ...
 */
public class DList {
	private DList self = this;
	
	protected int size;			// number of elements
	protected DNode header,		// header sentinel
	...
	public DList() {
		self.size = 0;
		self.header = new DNode( null, null, null );		// create header
		self.trailer = new DNode( null, header, null );		// create trailer
	...
	public void remove( DNode v ) {
		DNode u = self.getPrev( v );			// may throw an IllegalArgumentException
		DNode w = self.getNext( v );			// may throw an IllegalArgumentException
